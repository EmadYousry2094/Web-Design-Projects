...
function sliderInit (widthx,heightx) {
    ...
    if (widthx == 0 || widthx == undefined) {
    
        widthx = window.innerWidth-17;
    ...
    document.querySelector('.left-control').style.top = ((heightx/2) -25)+'px'
    document.querySelector('.right-control').style.top = ((heightx/2) -25)+'px'

    document.querySelector('.pagger').style.top = (heightx - (heightx/10) - 18)+'px'
